function Institute() {
  return (
    <div className="w-full text-cimc-standard">
      <p>THE MISSING INSTITUTE</p>
      <p className="py-2">
        We need an open, transdisciplinary, non-profit research initiative. This
        institute will integrate insights from philosophy, psychology,
